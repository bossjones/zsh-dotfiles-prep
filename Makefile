...
docker-run-test-debug:
	...
	docker run --rm --name test-container  -e ZSH_DOTFILES_PREP_GIT_NAME="Malcolm Jones" -e ZSH_DOTFILES_PREP_GIT_EMAIL=bossjones@theblacktonystark.com -e ZSH_DOTFILES_PREP_GITHUB_USER=bossjones $(REGISTRY_IMAGE):$(IMAGE_TAG) bin/zsh-dotfiles-prereq-installer-linux --debug
	docker logs test-container || true
	@echo "✅ Test completed"
...
docker-run-test-bash:
	...
	docker run --rm -it --name test-container --entrypoint bash -e ZSH_DOTFILES_PREP_GIT_NAME="Malcolm Jones" -e ZSH_DOTFILES_PREP_GIT_EMAIL=bossjones@theblacktonystark.com -e ZSH_DOTFILES_PREP_GITHUB_USER=bossjones $(REGISTRY_IMAGE):$(IMAGE_TAG)
	docker logs test-container || true
	@echo "✅ Test completed"
